...
#ifndef TOYWEBVSERVER_HTTPRESPONSE_H
#define TOYWEBVSERVER_HTTPRESPONSE_H
...
private:
    ...
    static const std::unordered_map<int, std::string> CODE_PATH_4XX;
};

#endif //TOYWEBVSERVER_HTTPRESPONSE_H
